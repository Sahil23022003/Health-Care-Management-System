            ...
            <div class="nav-wrapper"><!--main navigation-->
                <div class="container">
                    ...
                    <nav class="wsmenu slideLeft clearfix">
                        <div class="logo pull-left"><a href="index.php" title="Responsive Slide Menus"><h3 style="color:#08c2f3">HMS</h3></a></div>
                        <ul class="mobile-sub wsmenu-list pull-right">
                            <li><a href="index.php" class="">Home</a>
                                
                            </li>
                            
                            <li><a href="category.php">Hospitals<span class="arrow"></span></a></li>
                             <li><a href="blood.php">Blood Banks <span class="arrow"></span></a></li>
                           
                            <li><a href="ambulance.php">Ambulance <span class="arrow"></span></a></li>
                            <li><a href="bed.php">Bed Avalability <span class="arrow"></span></a></li>
